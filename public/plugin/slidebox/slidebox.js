$(document).ready(function(){
	...
	for (var i=0;i<$(".scrolltab .ulSmallPic li").length;i++) {
		(function(j) {
			$(".scrolltab .ulSmallPic li:eq("+j+")").click(function() {
				$(".scrolltab .dPicStatus .dPicStatusNav").html((j+1)+"/"+$(".scrolltab .ulSmallPic li").length);
				$(".scrolltab .dPicStatus .dPicStatusTitle").html($(this).find("span.sTitle").text());
				if($(this).attr("class") != "liSelected") {
					numInit(j);
					btnAInit();
					smallPicSelected();
	...
	$("#sLeftBtnB").click(function(){
		if($(this).attr("class")=="sLeftBtnBSel") {
			...
			leftPosition=leftPositionNum+135+"px";
			if(leftPosition=="0px") {if($(this).attr("class") != "sLeftBtnBBan") {$(this).attr("class","sLeftBtnBBan");}}
			var bestLeftNum=-($(".scrolltab .ulSmallPic li").length-5)*135;
			if((leftPositionNum+135) > bestLeftNum && $("sRightBtnB").attr("class") != "sRightBtnB") {$("#sRightBtnB").attr("class","sRightBtnB")}
	...
	$("#sRightBtnB").click(function(){
		if($(this).attr("class")=="sRightBtnBSel"){
			...
			leftPosition=leftPositionNum-135+"px";
			var bestLeftNum=-($(".scrolltab .ulSmallPic li").length-5)*135;
			if((leftPositionNum-135)==bestLeftNum) {$(this).attr("class","sRightBtnBBan");}
